...
export default function Login() {
  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-br from-neutral-50 via-white to-blue-50 dark:from-neutral-950 dark:via-neutral-900 dark:to-blue-950">
      ...
      <div className="relative min-h-screen flex flex-col justify-center container mx-auto px-4 py-8">
        <div className="flex flex-col items-center justify-center flex-1 mt-16 md:mt-20">
          {/* Header section */}
          <motion.div
          ...
          >
            ...
            <h1 className="text-5xl md:text-6xl font-extrabold mb-6 text-blue-600 dark:text-blue-400 bg-gradient-to-r from-blue-600 to-indigo-600 dark:from-blue-400 dark:to-indigo-400 bg-clip-text hover:text-transparent transition-all duration-300">
              Sign In
            </h1>
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto leading-relaxed">
              Access your account to manage appointments, view records, and
              more.
            </p>
          </motion.div>
