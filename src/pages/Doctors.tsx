    ...
    <div className="relative min-h-screen bg-gradient-to-br from-neutral-50 via-white to-blue-50 dark:from-neutral-950 dark:via-neutral-900 dark:to-blue-950">
      ...
      <div className="relative w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24">
        ...
        >
          ...
          <div className="w-full px-2 sm:px-4 md:px-6 lg:px-8 header-container">
            <h1 className="text-2xl xs:text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold mb-6 text-blue-600 dark:text-blue-400 leading-[1.1] sm:leading-tight break-words max-w-full overflow-visible mx-auto text-center">
              Find the Right Doctor
            </h1>
          </div>
          <p className="text-base sm:text-lg md:text-xl text-gray-600 dark:text-gray-300 max-w-4xl mx-auto leading-relaxed px-4 sm:px-6 lg:px-8">
            Connect with qualified healthcare professionals specializing in your
            needs. Filter by specialty, location, and availability.
          </p>
        </motion.div>
        <motion.div
          ...
          className="mb-12 w-full max-w-6xl mx-auto px-4"
        >
          <div className="bg-white dark:bg-neutral-800/90 backdrop-blur-sm rounded-2xl border border-blue-50 dark:border-neutral-700/80 p-4 sm:p-6 shadow-xl shadow-blue-900/5 dark:shadow-blue-900/30">
        ...
        {isLoading ? (
          ...
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            className="text-center py-16 bg-white dark:bg-neutral-800/90 backdrop-blur-sm rounded-2xl border border-blue-50 dark:border-neutral-700/80 shadow-xl shadow-blue-900/5 dark:shadow-blue-900/30 max-w-2xl mx-auto px-4 sm:px-6"
          >
            <Search
              size={48}
              className="mx-auto text-blue-400 dark:text-blue-500 mb-4 opacity-70"
            />
        ...
        {!isLoading && filteredDoctors.length > 0 && (
          <motion.div
            ...
            className="mt-24 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 w-full max-w-6xl mx-auto px-4"
          >
